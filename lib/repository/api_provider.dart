...
class ApiProvider {
  ...
  // final String _updateProfileReq = "public/api/user/update/profile";
  final String _updateProfileReq = "public/api/provider/profile";
  final String _changePasswordReq = "public/api/provider/profile/password";
  final String _pastHistoryTrip = "public/api/provider/requests/history";
  final String _fetchSummary = "public/api/provider/summary";
  ...
  Future<UserProfileRespo> updateProfile(String emailId,String mobileNumber,String firstName,String lastName,BuildContext context,String accessToken,String tokenType,String imagePath) async {
    ArsProgressDialog progressDialog = ArsProgressDialog(
        context,
        blur: 2,
        backgroundColor: Color(0x33000000),
...
print(imagePath);
    ...
    try {
      var params = {
        ...
        "email": emailId,
        "mobile": mobileNumber,
       if(imagePath!="") 'avatar': await MultipartFile.fromFile(
          imagePath,
          filename: "image",
        ),
      };
      ...
      Response response = await _dio.post(baseUrl + _updateProfileReq, data:data);
