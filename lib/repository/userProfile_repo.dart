...
class UserProfileRepo{
  ...
  Future<UserProfileRespo> updateUserProfile(String emailId,String fistName,String mobileNumber,String lastName,BuildContext context,String accessToken,String tokenType,String imagePath){
    return _apiProvider.updateProfile(emailId,mobileNumber,fistName,lastName,context, accessToken, tokenType,imagePath);
  }
