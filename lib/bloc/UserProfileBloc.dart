...
class UserProfileBloc {
  ...
  userProfileReq(String emailId, String firstName, String lastName,String mobileNumber,
      BuildContext context,String accessToken,String tokenType,String imagePath) async {
    UserProfileRespo response =
        await _userEditProfileRepository.updateUserProfile(emailId, firstName,mobileNumber, lastName, context, accessToken, tokenType,imagePath);
