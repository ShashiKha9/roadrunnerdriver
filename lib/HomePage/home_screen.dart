                      ...
                      children: [
                        Align(alignment: Alignment.bottomCenter,
                          child: Container(
                            ...
                            height: 100, alignment: Alignment.bottomCenter, color: Colors.white,
                          ),
                        ),
                        // DraggableScrollableSheet(
                        //     initialChildSize: 0.191,
                        //     expand: true,
                        //     maxChildSize: 0.321,
                        //     minChildSize: 0.19,
                        ...
                        Padding(
                            ...
                            child: request != null ? request.status == "COMPLETED" ?
                            DraggableScrollableSheet(
                        ...
                        Visibility(
                            ...
                            visible: request != null ? request.status == "SEARCHING" ? true : false : false,
                        ...
                        // cancel & onDuty
                        Visibility(
                            visible: request != null ? request.status == "STARTED" ? true : false : false,
                            child: Padding(
                                                    ...
                                                    RoundedRectangleBorder(
                                                        ...
                                                        side: BorderSide(
                                                            color: Colors
                                                                .green)))),
                                            onPressed: () async {
                                              String googleUrl = 'https://www.google.com/maps/search/?api=1&query=${request.dLatitude},${request.dLongitude}';
                        ...
                        // started work
                        Visibility(
                            visible: request != null ? request.status == "ARRIVED" ? true : false : false,
                            child: Padding(
                                padding: EdgeInsets.only(bottom: 20),
                                child: new Align(
                                    alignment: FractionalOffset.bottomCenter,
                        ...
                        // tap when job done
                        Visibility(
                            visible: request != null ? request.status == "PICKEDUP" ? true : false : false,
                            child: Padding(
                                padding: EdgeInsets.only(bottom: 20),
                                child:
                                new Align(
                        ...
                        // confirm payment
                        Visibility(
                            visible: request != null ? request.status == "DROPPED" ? true : false : false,
                            child: Padding(
                                padding: EdgeInsets.only(bottom: 20),
                                child: new Align(
                                    alignment: FractionalOffset.bottomCenter,
                        ...
                        // submit
                        Visibility(
                            visible: request != null ? request.status == "COMPLETED" ? true : false : false,
                            child: Padding(
                                padding: EdgeInsets.only(bottom: 20),
                                child: new Align(
                                    alignment: FractionalOffset.bottomCenter,
