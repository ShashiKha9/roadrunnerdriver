...
import 'package:cbx_driver/HomePage/AddCard.dart';
      ...
      body: FutureBuilder<bool>(
        ...
        builder: (BuildContext context, AsyncSnapshot<bool> snapshot) {
          if (!snapshot.hasData) {
            ...
            String currency = prefs.getString(SharedPrefsKeys.CURRENCY);
            String amount =prefs.getString(SharedPrefsKeys.WALLET_BALANCE);
            String walletBalance = amount =='null'?'0.00':amount;
